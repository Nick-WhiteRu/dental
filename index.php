...
<body>
    ...
    <div class="about-grid">
      <div class="about-visual fade-in">
        <div class="about-frame">
          <div class="about-frame-icon">🦷<p>тут должно быть фото клиники</p>
          </div>
        </div>
      ...
      <div class="about-text fade-in">
        ...
        <div class="about-features">
          <div class="feature-item">
            ...
            <p>Цифровая рентгенография и 3D-томография</p>
          </div>
          <div class="feature-item">
            <h4>Комфортная атмосфера</h4>
            <p>Приятная среда без стресса и долгого ожидания</p>
          </div>
          <div class="feature-item">
          ...
          <div class="feature-item">
            ...
            <p>Персональный план лечения для каждого</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="services">
    <div class="services-header">
      <div><span class="section-tag">Что мы предлагаем</span>
        <h2>Наши <em>услуги</em></h2>
      </div>
      <button class="btn-secondary" onclick="openModal()">Записаться</button>
    </div>
    <div class="services-grid">
      <div class="service-card fade-in"><span class="service-icon">🔬</span>
        <h3>Диагностика</h3>
        <p>Полная цифровая диагностика полости рта, 3D-томография, фотопротокол и составление индивидуального плана лечения.</p><span class="service-price">от 500 мдл</span>
      </div>
      <div class="service-card fade-in"><span class="service-icon">✨</span>
        <h3>Отбеливание</h3>
        <p>Профессиональное отбеливание зубов системой Zoom 4. Результат — улыбка на 8–10 тонов светлее за один визит.</p><span class="service-price">от 8 000 мдл</span>
      </div>
      <div class="service-card fade-in"><span class="service-icon">🦷</span>
        <h3>Терапия</h3>
        <p>Лечение кариеса, пульпита, периодонтита. Восстановление зубов светоотверждаемыми композитными материалами.</p><span class="service-price">от 2 500 мдл</span>
      </div>
      <div class="service-card fade-in"><span class="service-icon">🏗️</span>
        <h3>Имплантация</h3>
        <p>Установка имплантов швейцарского производства с пожизненной гарантией. Восстановление одного или нескольких зубов.</p><span class="service-price">от 35 000 мдл</span>
      </div>
      <div class="service-card fade-in"><span class="service-icon">😁</span>
        <h3>Ортодонтия</h3>
        <p>Элайнеры Invisalign и металлические брекеты. Исправление прикуса у детей и взрослых с применением новейших методик.</p><span class="service-price">от 45 000 мдл</span>
      </div>
      <div class="service-card fade-in"><span class="service-icon">💎</span>
        <h3>Виниры</h3>
        <p>Ультратонкие керамические виниры для идеальной улыбки. Коррекция формы, цвета и положения зубов без боли.</p><span class="service-price">от 18 000 мдл</span>
      </div>
    </div>
  </section>
    ...
    <div class="doctors-grid">
      <div class="doctor-card fade-in">
        <div class="doctor-photo">
          <div class="doctor-photo-icon">👨‍⚕️</div>
        </div>
  ...
  <section id="contact">
    <div class="contact-grid">
      <div>
        ...
        <div class="contact-item" style="margin-top:2rem"><span class="contact-label">Адрес</span>
          <div class="contact-value">Strada Mitropolit Petru Movilă 23/1, of.1, Chișinău<br></div>
        </div>
        <div class="contact-item"><span class="contact-label">Телефон</span>
          <div class="contact-value">022 235 117<br></div>
        </div>
        <div class="contact-item"><span class="contact-label">Электронная почта</span>
          <div class="contact-value">info@profesor.com</div>
        </div>
        <div class="contact-item"><span class="contact-label">Режим работы</span>
          <div class="contact-value">Пн–Пт: 8:00 – 18:00<br>Сб: 9:00 – 13:00 · Вс: выходной</div>
        </div>
  ...
  <div class="modal-overlay" id="modalOverlay" onclick="handleOverlayClick(event)">
    <div class="modal">
      ...
      <div class="modal-body">
        <div id="formContent">
          <form action="DBLogic/BookAppointment.php" method="POST" id="appointmentForm">
            <p id="formError" style="display:none;color:#a63b32;margin-bottom:1rem;"></p>
            <div class="form-row">
              <div class="form-group"><label>Имя *</label><input type="text" id="fname" placeholder="Вова" name="first_name" required></div>
              <div class="form-group"><label>Фамилия *</label><input type="text" placeholder="Никита" name="last_name" required></div>
            </div>
            <div class="form-group"><label>Телефон *</label><input type="tel" id="fphone" placeholder="+373 (___) ___-__-__" name="phone" required></div>
            <div class="form-group"><label>Электронная почта</label><input type="email" placeholder="nikita.boss2007@gmail.com" name="email"></div>
            <div class="form-group">
              <label>Услуга</label>
              <select name="service_id" required>
                <option value="">— Выберите услугу —</option>
                <option value="1">Диагностика</option>
                <option value="2">Отбеливание</option>
                <option value="3">Терапия (лечение кариеса)</option>
                <option value="4">Имплантация</option>
                <option value="5">Ортодонтия</option>
                <option value="6">Виниры</option>
                <option value="7">Другое</option>
              </select>
            </div>
            <div class="form-row">
              <div class="form-group"><label>Удобная дата</label><input type="date" id="apptDate" name="appointment_date"></div>
              <div class="form-group">
                <label>Удобное время</label>
                <select name="slot_id" id="appointmentTime" required>
                  <option value="">— Выберите время —</option>
                </select>
              </div>
            </div>
            <div class="form-group"><label>Комментарий</label><textarea placeholder="Опишите проблему или пожелания..." name="comment"></textarea></div>
  ...
  <script>
    const bookingDateInput = document.getElementById('apptDate');
    const bookingPicker = bookingDateInput ? bookingDateInput._flatpickr : null;
    ...
    async function refreshCalendarMonth(date) {
      ...
      if (selectedDate && !availableDates.includes(selectedDate)) {
        bookingPicker.clear();
        if (typeof setTimeOptions === 'function') {
          setTimeOptions([]);
        }
      }
    }
    ...
    if (bookingPicker) {
      bookingPicker.config.onReady.push(function(selectedDates, dateStr, instance) {
        refreshCalendarMonth(new Date(instance.currentYear, instance.currentMonth, 1));
      });

      bookingPicker.config.onMonthChange.push(function(selectedDates, dateStr, instance) {
        refreshCalendarMonth(new Date(instance.currentYear, instance.currentMonth, 1));
      });

      bookingPicker.config.onYearChange.push(function(selectedDates, dateStr, instance) {
        refreshCalendarMonth(new Date(instance.currentYear, instance.currentMonth, 1));
      });
